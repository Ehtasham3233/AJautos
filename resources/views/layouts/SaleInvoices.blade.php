...
<script>
    $(document).ready(function () {
        let table = $('#DataTables_Table_0').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "/get-listSaleInvoices", // ✅ Updated API endpoint
                type: "GET",
            ...
            columns: [
                { data: "id", name: "id" }, // Serial Number
                { data: "registrationNumber", name: "registrationNumber" }, // Car Registration Number
                { data: "customer_name", name: "customer_name" }, // Customer Name
                { data: "customer_phone", name: "customer_phone" }, // Customer Phone
                { data: "make_year", name: "make_year" }, // Make/Model/Year
                { data: "amount", name: "amount" }, // Amount with Euro Sign
            ...
            initComplete: function () {
                ...
                <div class="d-flex align-items-center">
                    ...
                    <button class="btn btn-primary fw-bold text-white mt-1" style="margin-right: 10px" data-bs-toggle="modal">
                         Add Record
                    </button>
                </div>
            `);
