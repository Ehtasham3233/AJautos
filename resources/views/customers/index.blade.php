            ...
            buttons: [
                {
                    ...
                    attr: { id: 'printBtn' },
                    autoPrint: false, // Prevent automatic print dialog
                    ...
                    exportOptions: {
                        ...
                        modifier: {
                            page: 'all' // Print all pages, not just the current page
                        }
                    }
                },
                {
